          ...
          return (
            <li key={account.id}>
              <Link
                ...
                className="card group block p-5 transition hover:border-navy-300"
              >
                <div className="flex items-start justify-between gap-4">
                  <div>
                    <div className="flex flex-wrap items-center gap-2">
                      <p className="text-base font-semibold text-navy-900">{account.nickname}</p>
                  ...
                  <div className="text-right">
                    <p className="text-2xl font-semibold tracking-tight text-navy-900 tnum">
                    ...
                    <div className="h-1.5 overflow-hidden rounded-full bg-slate-100">
                      <div
                        className={`h-full rounded-full transition-all duration-500 ${
                          utilization > 0.7 ? 'bg-brand-500' : utilization > 0.3 ? 'bg-amber-500' : 'bg-navy-500'
                        }`}
                ...
                {account.rewardsCents !== null && account.rewardsCents > 0 && (
                  <p className="mt-3 inline-block rounded-lg bg-navy-50 px-2.5 py-1 text-xs font-semibold text-navy-700 tnum">
