  ...
  return (
    <div>
      <PageHeader
        ...
        title="My plans"
        subtitle="Purchases you've split into monthly payments."
      />
      ...
      <section className="mb-5 grid gap-4 sm:grid-cols-3">
        ...
        <div className="card p-5">
          ...
          <p className="mt-1 text-xs text-navy-600">original purchase value</p>
        </div>
        <div className="card p-5">
          ...
          <p className="mt-1 text-xs text-navy-600">across all active plans</p>
        </div>
      </section>
                ...
                <div className="flex flex-wrap items-start justify-between gap-3">
                  <div>
                    <div className="flex flex-wrap items-center gap-2">
                      <p className="text-base font-semibold text-navy-900">{plan.merchantName}</p>
                  ...
                  <div className="text-right">
                    <p className="text-lg font-semibold text-navy-900 tnum">
                      {formatCents(plan.monthlyPaymentCents)}
                    </p>
                    <p className="text-xs text-navy-600">per month</p>
                  </div>
                </div>
